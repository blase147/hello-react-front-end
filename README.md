...
**Hello React Frontend** is an implemention of a connection between Ruby on Rails back-end and React front-end. [Hello Rails Backend](https://github.com/blase147/hello-rails-back-end) handles the backend API, and [Hello React Frontend](https://github.com/blase147/hello-react-front-end) handles the frontend UI to display a random greeting message.
...
- [API](https://github.com/blase147/hello-react-front-end)
...
Feel free to check the [issues page](https://github.com/blase147/hello-react-front-end/issues).
